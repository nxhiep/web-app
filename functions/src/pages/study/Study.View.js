...
var QuestionProgressPanelUI = props => {
  var _a, _b, _c; // console.log("QuestionProgressPanelUI props", props, 'theme', theme);
...
var _default = (0, _reactRedux.connect)(mapStateToPropsMain, mapDispatchToPropsMain)((0, _styles.withTheme)(StudyViewScreen));
