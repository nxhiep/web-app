...
class TopicProgress {
  ...
  static getArguments() {
    return ['id', 'topicId', 'status', 'lock', 'lastUpdate', 'userId', 'progress', 'notSeen', 'familiar', 'mastered', 'playing'];
  }
  ...
  static fromJS(topicProgressEntity) {
    ...
    if (typeof topicProgressEntity === 'string') {
      ...
      var convert = {};
      var keysOfChoiceJS = Object.keys(topicProgressEntity);
      var valuesOfChoiceJS = Object.values(topicProgressEntity);
