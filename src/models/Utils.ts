...
export const setSEOContent = (props: {
    ...
    if(props.title){
        ...
        if(!metaOgTitleElement){
            ...
            headElement?.appendChild(metaOgTitleElement);
        }
        if(metaOgTitleElement) {
    ...
    if(props.description){
        ...
        if(!metaOgDescriptionElement){
            ...
            headElement?.appendChild(metaOgDescriptionElement);
        }
        if(metaOgDescriptionElement){
    ...
    if(props.icon){
        ...
        if(!metaOgIconElement){
            ...
            headElement?.appendChild(metaOgIconElement);
        }
        if(metaOgIconElement){
    ...
    if(!metaOgLinkElement){
        ...
        headElement?.appendChild(metaOgLinkElement);
    }
    if(metaLinkElement){
        if(props.link){
